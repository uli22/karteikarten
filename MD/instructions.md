...
**REGEL**: Alle `.md`-Dateien (Dokumentation, Notizen, Richtlinien) gehören in den Ordner `MD/` im Projektstamm. Dies gilt für alle neu erstellten wie auch verschobene Markdown-Dateien. Der Projektstamm selbst soll frei von `.md`-Dateien bleiben.
